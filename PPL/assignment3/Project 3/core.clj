...
(comment (comment ----------------test cases --------------- )
(comment pascal's triangle test. Should yield 30405943383200.)   
(mypastri 50 22)

(comment merge test. should yield ( 1 3 4 5 6 10 11 12) )
(mymerge '( 1 4 7 11) '( 3 5 6 10 12 ) )

(comment mergesort test. Should yield ( 1 2 3 4 5 6 7) )
(mymergesort '(3 1 7 5 2 6 4 ))

(comment binary search tree test. Should yield (3 (1 nil nil) (7 (5 nil nil) nil ) ) )
(mybuildbst '(3 1 7 5) )
